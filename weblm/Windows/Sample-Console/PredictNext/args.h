...
class args
{
	...
	public:
		...
		{
			wcout << L"List a set of candidate words predicted to follow a given phrase" << endl;
			wcout << L"usage: PredictNext ";
			for (auto option : options)
			{
